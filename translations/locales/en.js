(() => {
  ...
  window.MindsweeperTranslations.TRANSLATIONS['en'] = {
    ...
    history: {
      ...
      importEmpty: 'No imported runs yet.',
      filterResult: 'Result',
      filterTime: 'Time',
      filterAll: 'All',
      filterWins: 'Wins',
      ...
      importHint: 'Load exported JSON runs to replay them here.',
    },
    status: {
      ...
      exportHistory: 'Exported {count} runs to JSON.',
      exportHistoryEmpty: 'No runs to export.',
      exportRun: 'Exported run to JSON.',
      importSuccess: 'Imported {count} runs.',
      importEmpty: 'No runs found in that file.',
      importInvalid: 'Some runs were skipped because they were invalid.',
      importFailed: 'Unable to import that file.',
      importMissingSeed: 'This run is missing a seed and layout data.',
    },
    hint: {
