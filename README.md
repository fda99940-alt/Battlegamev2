...
9. **History + replay**: Runs capture timestamps, configurations, layouts, mine positions, special trigger counts, and action sequences; the panel lets you replay, delete, or clear them. Each entry also exposes a copyable room code plus a join form for instant replays.
